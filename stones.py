...
__GPIO_PIN_MUL_EN_1_IN__ = 0
__GPIO_PIN_MUL_EN_2_IN__ = 0
__GPIO_PIN_MUL_EN_1_OUT__ = 0
__GPIO_PIN_MUL_EN_2_OUT__ = 0
__GPIO_PIN_MUL_STONES_IN_ADDRESS_START__ = 0  #(S3 Address)  EN1 S0 S1 S2 S3 EN2
__GPIO_PIN_MUL_STONES_OUT_ADDRESS_START__ = 0 # S3 is MSB
